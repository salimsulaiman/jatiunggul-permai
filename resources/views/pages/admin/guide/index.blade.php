        ...
        <div class="w-full flex items-center justify-between mb-4">
            ...
            <div class="flex gap-2 items-center">
                <button class="px-4 py-2 text-sm rounded-xl bg-sky-700 hover:bg-sky-800 text-white "
                    data-modal-target="add-guide-modal" data-modal-toggle="add-guide-modal">Add Guide</button>
                <div id="add-guide-modal" tabindex="-1" aria-hidden="true"
                        ...
                        <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
                            ...
                            <div
                                ...
                                <button type="button"
                                    ...
                                    data-modal-hide="add-guide-modal">
                            ...
                            <!-- Modal body -->
                            <form class="w-full" method="POST" action="{{ route('admin.guide.store') }}"
                                ...
                                <div class="p-4 md:p-5 space-y-4">
                                    ...
                                    <div class="mb-5">
                                        ...
                                        <textarea id="description" rows="4" name="description"
                                            ...
                                            placeholder="Write guide description here...">{{ old('description') }}</textarea>
                                    </div>
                                    <div class="">
                                        <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
                                            for="guide_file">Guide File</label>
                                        <input name="guide_file"
                                            class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400"
                                            id="guide_file" type="file">
                                    </div>
                                </div>
                                <!-- Modal footer -->
                                <div
                                    ...
                                    <button type="submit"
                                        ...
                                        Add</button>
                                    <button data-modal-hide="add-guide-modal" type="button"
            ...
            <table id="search-table">
                ...
                <tbody>
                    @foreach ($guides as $guide)
                        <tr>
                            <td class="font-medium text-gray-900 whitespace-nowrap dark:text-white">{{ $guide->title }}
                            </td>
                            <td>
                                <div class="w-16 h-16 rounded-xl relative overflow-hidden">
                                    <img src="{{ asset('storage/' . $guide->image) }}" alt="img-{{ $guide->name }}"
                                        class="w-full h-full object-cover object-center">
                                </div>
                            </td>
                            <td class="max-w-sm">{{ $guide->description }}</td>
                            <td class="w-px whitespace-nowrap">
                                <div class="flex items-center gap-2">

                                    <button data-modal-target="view-guide-modal-{{ $guide->id }}"
                                        data-modal-toggle="view-guide-modal-{{ $guide->id }}"
                                        class="p-3 text-sm rounded-full bg-sky-500 hover:bg-sky-600 text-white">
                                        <i data-feather="eye" class="size-3"></i>
                                    </button>

                                    <button data-modal-target="update-guide-modal-{{ $guide->id }}"
                                        data-modal-toggle="update-guide-modal-{{ $guide->id }}"
                                        class="p-3 text-sm rounded-full bg-yellow-500 hover:bg-yellow-600 text-white">
                                        <i data-feather="edit-2" class="size-3"></i>
                                    </button>

                                    <button data-modal-target="delete-guide-modal-{{ $guide->id }}"
                                        data-modal-toggle="delete-guide-modal-{{ $guide->id }}"
                        ...
                        {{-- view-modal --}}
                        <div id="view-guide-modal-{{ $guide->id }}" tabindex="-1" aria-hidden="true"
                            class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                            <div class="relative p-4 w-full max-w-2xl max-h-full">
                                <!-- Modal content -->
                                <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
                                    ...
                                    <div
                                        ...
                                        <button type="button"
                                            class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white"
                                            data-modal-hide="view-guide-modal-{{ $guide->id }}">
                                            <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                                fill="none" viewBox="0 0 14 14">
                                                <path stroke="currentColor" stroke-linecap="round"
                                                    stroke-linejoin="round" stroke-width="2"
                                        ...
                                        <div class="p-4 md:p-5 space-y-4">
                                            ...
                                            <div class="mb-5">
                                                ...
                                                <textarea id="description" rows="4" name="description" readonly
                                                    ...
                                                    placeholder="Write guide description here...">{{ $guide->description }}</textarea>
                                            </div>
                                            <div class="w-full">
                                                <label
                                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                                                ...
                                                <input type="text"
                                                    class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-100
               dark:text-gray-400 dark:bg-gray-700 dark:border-gray-600"
                                                    :value="'{{ basename($guide->guide_file) }}'" readonly>

                                                <a href="{{ asset('storage/' . $guide->guide_file) }}" target="_blank"
                                        ...
                                        <div
                                            class="flex items-center p-4 md:p-5 border-t border-gray-200 rounded-b dark:border-gray-600">
                                            <button data-modal-hide="view-guide-modal-{{ $guide->id }}" type="button"
                                                class="py-2.5 px-5 ms-3 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">Decline</button>
                                        </div>
                                    </div>
                                </div>
                        ...
                        {{-- update-modal --}}
                        <div id="update-guide-modal-{{ $guide->id }}" tabindex="-1" aria-hidden="true"
                            class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                            <div class="relative p-4 w-full max-w-2xl max-h-full">
                                <!-- Modal content -->
                                <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
                                    ...
                                    <div
                                        ...
                                        <button type="button"
                                            class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white"
                                            data-modal-hide="update-guide-modal-{{ $guide->id }}">
                                            <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                                fill="none" viewBox="0 0 14 14">
                                                <path stroke="currentColor" stroke-linecap="round"
                                                    stroke-linejoin="round" stroke-width="2"
                                    ...
                                    <!-- Modal body -->
                                    <form class="w-full" action="{{ route('admin.guide.update') }}" method="POST"
                                        enctype="multipart/form-data">
                                        @csrf
                                        @method('PUT')
                                        <div class="p-4 md:p-5 space-y-4">
                                            ...
                                            <div class="mb-5" x-data="imagePreview('{{ old('image') ?? ($guide->image ?? '') }}', 'dropzone-file-edit')" x-init="init()">
                                                <label for="image"
                                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Image</label>
                                            ...
                                            <div class="">
                                                ...
                                                @if ($guide->guide_file)
                                                    <div class="mb-2">
                                                        <p class="text-sm text-gray-600 dark:text-gray-300">File
                                                            sebelumnya:</p>
                                                        <a href="{{ asset('storage/' . $guide->guide_file) }}"
                                        ...
                                        <div
                                            ...
                                            <button type="submit"
                                                class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                                Update</button>
                                            <button data-modal-hide="update-guide-modal-{{ $guide->id }}"
                                                type="button"
                                                class="py-2.5 px-5 ms-3 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">Decline</button>
                                        </div>
                                    </form>
                        ...
                        {{-- delete modal --}}
                        <div id="delete-guide-modal-{{ $guide->id }}" tabindex="-1" aria-hidden="true"
                            class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                            <div class="relative p-4 w-full max-w-2xl max-h-full">
                                <!-- Modal content -->
                                <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
                                    ...
                                    <div
                                        ...
                                        <button type="button"
                                            class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white"
                                            data-modal-hide="delete-guide-modal-{{ $guide->id }}"}}">
                                            <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                                fill="none" viewBox="0 0 14 14">
                                                <path stroke="currentColor" stroke-linecap="round"
                                                    stroke-linejoin="round" stroke-width="2"
                                    ...
                                    <!-- Modal body -->
                                    <form class="w-full" action="{{ route('admin.guide.destroy', $guide->id) }}"
                                        method="POST">
                                        @csrf
                                        @method('DELETE')
                                        <div class="p-4 md:p-5 space-y-4">
                                            <div class="w-full">
                                                ...
                                                <p class="text-base leading-relaxed text-gray-500 dark:text-gray-400">
                                                    Are you sure want to delete {{ $guide->title }}?
                                                    This action
                                                    cannot be undone.
                                                </p>
                                            </div>
                                        ...
                                        <div
                                            ...
                                            <button type="submit"
                                                ...
                                                Delete</button>
                                            <button data-modal-hide="delete-guide-modal-{{ $guide->id }}"}}"
                                                type="button"
                                                class="py-2.5 px-5 ms-3 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">Decline</button>
                                        </div>
                                    </form>
