...
@section('content')
    <div class="w-full">
        <div class="w-full bg-cover bg-top bg-no-repeat relative bg-fixed"
            ...
            <div
                class="w-full max-w-6xl h-fit sm:h-[448px] px-4 sm:px-8 pt-24 sm:pt-8 pb-8 mx-auto flex flex-col justify-end items-start relative z-10">
            ...
            <div class="w-full grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 mt-8">
                <div class="w-full flex flex-col gap-4 group" data-aos="zoom-in">
                    <div class="w-full relative aspect-video bg-slate-100 overflow-hidden rounded-lg">
                        <img src="{{ asset('/assets/images/houses.png') }}"
                        ...
                        <div
                            ...
                            <h4 class="text-white px-3 py-1 bg-white/15 backdrop-blur-2xl w-fit rounded-full text-xs">Brebes
                            </h4>
                            <div
                                ...
                                <a href="/properties/townhouse-jatibarang" class="text-white text-lg sm:text-xl">
                                    Jati Unggul Permai Jatibarang
                                </a>
                                <a href="/properties/townhouse-jatibarang" wire:navigate
